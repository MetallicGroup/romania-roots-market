...
export const products: Product[] = [
  ...
  { id: "3", name: "Dulceață de afine", region: "Suceava", category: "dulceturi", weights: ["220g", "400g"], price: 32, image: dulceataAfine, swatch: "linear-gradient(160deg,#5a3a7a,#241436)", producer: "Cămara Anicăi", description: "Afine culese din poienile Bucovinei, fierte încet, fără conservanți." },
  ...
  { id: "5", name: "Dulceață de trandafiri", region: "Constanța", category: "dulceturi", weights: ["220g"], price: 36, image: dulceataTrandafiri, swatch: "linear-gradient(160deg,#e78ba5,#9a3a55)", producer: "Grădina Mariei", description: "Petale de trandafir de Damasc, fierte la ceaun. Parfum inconfundabil." },
  { id: "6", name: "Zacuscă de casă", region: "Iași", category: "muraturi", weights: ["300g", "500g"], price: 28, image: zacusca, swatch: "linear-gradient(160deg,#c05c2a,#5a2010)", producer: "Bunica Veta", description: "Vinete coapte pe lemne, gogoșari și ceapă. Rețetă de familie." },
  ...
  { id: "8", name: "Făină de porumb", region: "Timiș", category: "cereale", weights: ["500g", "1kg"], price: 18, image: fainaPorumb, swatch: "linear-gradient(160deg,#f5d97a,#b78018)", producer: "Moara Veche", description: "Măcinată la piatră, pentru mămăliga adevărată." },
  { id: "9", name: "Gogoșari în oțet", region: "Dolj", category: "muraturi", weights: ["720ml"], price: 22, image: gogosari, swatch: "linear-gradient(160deg,#c74a2a,#5a1810)", producer: "Cămara din Deal", description: "Gogoșari cărnoși, în oțet de mere și miere." },
];
